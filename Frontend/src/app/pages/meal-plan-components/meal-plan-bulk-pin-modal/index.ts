...
export class MealPlanBulkPinModalPage {
  ...
  selectAllRecipes() {
    ...
    (this.mealItems || [])
      ...
      .forEach(mealItem => this.recipeIdSelectionMap[mealItem.recipe.id] = true);
  }

  deselectAll() {
    this.allSelected = false;
    Object.keys(this.recipeIdSelectionMap).forEach(recipeId => this.recipeIdSelectionMap[recipeId] = false);
  }
