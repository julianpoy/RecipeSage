...
module.exports = {
  ...
  excludeFiles: [
    ...
    /(action-sheet|checkbox|chip|datetime|img|infinite-scroll|loading|note|picker|range|segment|select|slides|split-pane|tabs|toggle|virtual-scroll|cordova)/i,
  ],
