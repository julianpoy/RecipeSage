...
module.exports = {
  ...
  excludeFiles: [
    /*  /\.(wp).(scss)$/i  */
    /(action-sheet|checkbox|chip|datetime|img|infinite-scroll|loading|note|picker|radio|range|segment|select|show-hide-when|slides|tabs|virtual-scroll|cordova)/i,
  ],
