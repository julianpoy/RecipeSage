...
@Component({
  standalone: true,
  selector: "page-import-cookbookmanagercom",
  templateUrl: "import-cookbookmanagercom.page.html",
  styleUrls: ["import-cookbookmanagercom.page.scss"],
  imports: [
    ...SHARED_UI_IMPORTS,
    IonHeader,
    IonToolbar,
...
export class ImportCookbookManagerComPage {
  ...
  async submit() {
    ...
    const response = await this.importService.importCookbookManagerCom(
      this.file,
      {
        413: () => {
