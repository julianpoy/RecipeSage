...
export const startCookbookJob = authenticatedProcedure
  ...
  .input(
    z.object({
      ...
      includeLastMade: z.boolean().optional(),
      includeLinkedRecipes: z.boolean().optional(),
      includeRecipeSageUrl: z.boolean().optional(),
    ...
    const job = await prisma.job.create({
      data: {
        ...
        meta: {
          ...
          cookbookIncludeLastMade: input.includeLastMade,
          cookbookIncludeLinkedRecipes: input.includeLinkedRecipes,
          cookbookIncludeRecipeSageUrl: input.includeRecipeSageUrl,
