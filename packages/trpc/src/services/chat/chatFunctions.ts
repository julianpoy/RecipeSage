...
export const initBuildRecipe = (
  ...
  function: {
    name: "displayRecipe",
    description: "Displays a recipe in-app to the user. This must always be used any time you use ingredients or instructions in your response.",
    parse: JSON.parse,
    function: (args: any) => {
      ...
      const recipe: Prisma.RecipeUncheckedCreateInput = {
        ...
        activeTime: typeof args.activeTime === 'string' ? args.activeTime : null,
        totalTime: typeof args.totalTime === 'string' ? args.totalTime : null,
        ingredients: Array.isArray(args.ingredients) ? args.ingredients.join('\n') : null,
        instructions: Array.isArray(args.instructions) ? args.instructions.join('\n') : null,
        notes: null,
      };
    ...
    parameters: {
      ...
      properties: {
        ...
        totalTime: {
          type: "string",
          description: "The total amount of time it will take to cook the recipe including prep"
        },
        ingredients: {
          type: "array",
          items: {
