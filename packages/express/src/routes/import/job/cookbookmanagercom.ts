...
export const cookbookmanagercomHandler = defineHandler(
  {
    schema,
    authentication: AuthenticationEnforcement.Required,
    openapi: {
      operationId: "import-importCookbookmanagercom",
      method: "post",
      path: "/import/job/cookbookmanagercom",
      tags: ["import"],
      summary: "Import recipes from a CookBookManager.com export",
      successStatus: 201,
      upload: {
        field: "file",
      },
