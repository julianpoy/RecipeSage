...
export const flavorishHandler = defineHandler(
  {
    schema,
    authentication: AuthenticationEnforcement.Required,
    openapi: {
      operationId: "import-importFlavorish",
      method: "post",
      path: "/import/job/flavorish",
      tags: ["import"],
      summary: "Import recipes from a Flavorish export",
      successStatus: 201,
      upload: {
        field: "file",
      },
