...
export const flavorish: CompetitorData = {
  ...
  table: [
    ...
    },
    {
      ...
      recipesage: true,
      competitor: "$4.99/month or $49.99/year",
      note: "Flavorish's AI recipe generation requires Premium. RecipeSage's AI assistant can create recipes from the ingredients you have or a diet you follow, included for free.",
    },
