...
export const cookbookmanager: CompetitorData = {
  ...
  table: [
    ...
    },
    {
      ...
      recipesage: true,
      competitor: "20 free imports, then Pro",
      note: "CookBookManager's free plan includes 20 smart imports in total, shared across web, social media, and photo imports. Unlimited imports require CookBook Pro. RecipeSage imports are unlimited and free.",
    },
    {
    ...
    { feature: "Open source", recipesage: true, competitor: false },
    {
      ...
      recipesage: true,
      competitor: "partial",
      note: "CookBookManager's nutrition calculator requires CookBook Pro and tracks calories, protein, carbs, and fat. RecipeSage is free and adds vitamins and minerals and can auto-fill from a pasted nutrition label.",
    },
    {
    ...
    { feature: "Web app", recipesage: true, competitor: true },
    {
      ...
      recipesage: true,
      competitor: "20 free imports, then Pro",
      note: "CookBookManager scans photos with AI, and each scan counts toward the free plan's 20 smart imports. RecipeSage imports from a photo of a cookbook page or handwritten card with no limit.",
    },
    {
      feature: "Import from social media (Instagram, TikTok, and more)",
      recipesage: true,
      competitor: "20 free imports, then Pro",
      note: "Social media imports count toward CookBookManager's 20 free smart imports.",
    },
    {
    ...
    { feature: "Ad-free", recipesage: true, competitor: true },
    {
      ...
      recipesage: true,
      competitor: "CookBook Pro",
      note: "CookBookManager's AI recipe creation and variations require CookBook Pro. RecipeSage's AI cooking assistant is free.",
    },
