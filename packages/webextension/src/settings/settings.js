let loggedInMessage = document.getElementById("loggedInMessage"),
  loggedOutMessage = document.getElementById("loggedOutMessage");
chrome.storage.local.get(["token"], function (result) {
  if (result.token) {
    fetch(`https://api.recipesage.com/users?token=${result.token}`)
